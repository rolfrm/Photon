...
(load-symbol libglfw (quote glfw-create-window) (quote glfwCreateWindow) (type (fcn (ptr void) (width i32) (height i32) (title (ptr char)) (a (ptr void)) (b (ptr void)))))
(glfw-init)
(defvar win (glfw-create-window (cast 512 i32) (cast 512 i32) "test.." (cast 0 (ptr void)) (cast 0 (ptr void))))
(usleep (cast 1000000 i32))
(write_line "done..")
